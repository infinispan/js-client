...
Use `query` method to query caches. Client must be configured to have `application/x-protostream` data format for values. See https://infinispan.org/docs/stable/titles/query/query.html[Querying Infinispan] for more info.
