  ...
  var Connection = function(addr, router) {
    ...
    function onData(data) {
      ...
      while (!replayable.isEmpty() && canDecodeMore) {
        ...
        //  } else {
        //    var rpc = router.findRpc(header.msgId);
        //    var body = protocol.decodeBody(rpc.decoder, header, bytebuf);
        //    canDecodeMore = body.continue;
        //    if (canDecodeMore) {
        //      trim(header, bytebuf);
        //      complete(rpc, header, topology, body);
        //    } else {
        //      rewind(); // Incomplete body, rewind
        //    }
        //  }
        //} else {
        //  canDecodeMore = false;
        ...
        //      : protocol.decodeBody(header, bytebuf);
        //  canDecodeMore = decoded.continue;
        //}
        //
        //if (!canDecodeMore) {
        //  logger.tracef("Incomplete response or event, rewind buffer and wait more data");
