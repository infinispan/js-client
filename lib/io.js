    ...
    function mainConnection(conn) {
      if (o.authOpts().enabled) {
        return conn.connect().then(function () {
          ...
          //   throw new Error(o.authOpts().saslMechanism + ' mechanism not supported. Supported mechanism are the ones in this list : ' + authMechs);
          // }
