    ...
    function aroundClusterSwitch(clusterSwitchF, clusterFailF) {
      ...
      return clusterSwitchF()
          .catch(function(err) {
              ...
              logger.debugf('aroundClusterSwitch catch error., set clusterSwitchInProgress=false');
              clusterSwitchInProgress = false;
          }).finally(function () {
            logger.debugf('aroundClusterSwitch finally, set clusterSwitchInProgress=false');
            clusterSwitchInProgress = false;
          });
    }
