(function() {
  ...
  function doDecodeQuery(bytebuf,protostreamTypename,root){
    var queryResp = decodeProtobufMessage(Query.QueryResponse)(trimBytebuf(bytebuf));
    var results = queryResp.results;
    return results.map(f.curry3(decodeWrappedBytes)(root)(protostreamTypename));
  }
