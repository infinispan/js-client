(function() {
  ...
  function doDecodeQuery(bytebuf,protostreamTypename,root){
    var queryResults = decodeProtobufMessage(Query.QueryResponse)(trimBytebuf(bytebuf)).results;
    var results = queryResults.map(f.curry3(decodeWrappedBytes)(root)(protostreamTypename));
