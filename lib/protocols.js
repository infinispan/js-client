...
(function() {
  ...
  var NoMediaTypeMixin = (function() {
    return {
      encodeMediaType: function (opts) {
        return []; // no media types
      }
    }
  }());

  var MediaTypeMixin = (function() {
    return {
      encodeMediaType: function (opts) {
        // TODO support user-provided media types
        return [
          codec.encodeUByte(1)
          , codec.encodeUByte(13)
          , codec.encodeUByte(0)
          , codec.encodeUByte(1)
          , codec.encodeUByte(13)
          , codec.encodeUByte(0)
  ...
  var Protocol28 = function(clientOpts) {
    Protocol.call(this, 28, clientOpts);
  };
  ...
  exports.version28 = function(clientOpts) {
    return new Protocol28(clientOpts);
  };
