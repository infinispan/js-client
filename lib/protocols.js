...
(function() {
  ...
  var MediaType = function(mediaType) {
    ...
    function encoderProtobuf(message){
      var typeId = ProtostreamType.lookupProtostreamTypeByName(message.$type.fullName);
      return f.pipeline(message,f.curry2(codec.encodeProtobuf)(message.$type),f.curry2(codec.encodeWrappedMessage)(typeId),codec.encodeBytesWithLength);
    }
