...
(function() {
  ...
  var EncodeMixin = {
    ...
    encodeHeader: function (op, opts, topologyId) {
      ...
      return function(id) {
        return [
          ...
          codec.encodeUByte(2),                           // basic client intelligence
  ...
  var DecodeMixin = (function() {
    ...
    function decodeIfMore(decoder, header, bytebuf) {
      var objs = [];
      do {
      ...
      return {result: objs, continue: true};
    }
    ...
    return {
      ...
      decodeVersioned: function(header, bytebuf) {
        return decodeObject(header, bytebuf, DECODE_VERSIONED);
      },
      ...
      decodeValues: function(header, bytebuf) {
        return decodeIfMore(DECODE_PAIR, header, bytebuf);
      },
      decodeKeys: function(header, bytebuf) {
        return decodeIfMore(DECODE_OBJECT, header, bytebuf);
      },
      decodeTopology: function(bytebuf) {
        ...
        return {id: topologyHeader.id, servers: addrs, done: true};
      },
  ...
  var IteratorMixin = (function() { // protocol 2.3+
    ...
    return {
      ...
      decodeIterId: function(header, bytebuf) {
        var iterId = DECODE_STRING(bytebuf);
        return {result: iterId, continue: true};
      },
