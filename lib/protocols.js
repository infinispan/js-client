...
(function() {
  ...
  var scramSha1 = factory.use(require('sasl-scram-sha-1')).create(['SCRAM-SHA-1']);
            ...
            switch (authOpts.saslMechanism) {
              ...
              case 'SCRAM-SHA-1':
                ...
                if (challenge == undefined) {
                  ...
                  challengeNum = 1;
                  initial = scramSha1.response({username: authOpts.userName, password: authOpts.password});
                  console.log('initial');
                  console.log(initial);
                ...
                console.log(challenge);
                console.log('buffer');
                console.log( Buffer.from('n,,').toString('base64'));

                var finalMessageWithoutProof = 'c=' + Buffer.from('n,,').toString('base64') + ',r=' + challenge;
                console.log( 'finalMessageWithoutProof');
                console.log( finalMessageWithoutProof);
                challengeNum = 2;
                console.log('client proooof');
                console.log(authOpts);
                // var clientProof = scramSha1.response({username: authOpts.userName, password: authOpts.password});
                console.log(initial);
                console.log('second response ...');
                var secondResp = finalMessageWithoutProof + ',p=' + initial;

                console.log('challenge')
                console.log(challenge);

                console.log('challenge')
                //r=d0211658dc323c3ff3f8254708cd57ddtX|C)}k;EO:f:tKfZnCELvCd]O\=,s=UHwYDYwCN1GfyHd0,i=20000
                var split = challenge.split(',');
                console.log(split);
                var r = split[0].split('r=');
                var s = split[1].split('s=');
                var i = split[2].split('i=');
                console.log(r[1]);
                console.log(s[1]);
                console.log(i[1]);

                var realChallenge = 'r=' + r[1] + ',s="' +s[1] + '",i=' + i[1];
                console.log(realChallenge);
                var scramSecResp = scramSha1.challenge(realChallenge)
