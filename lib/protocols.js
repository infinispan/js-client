...
(function() {
  ...
  var EncodeMixin = {
    ...
    encodeKeyValue: function (k, v, opts) {
      var expiry = this.encodeExpiry(opts);
      return function() {
        return f.cat(
          [codec.encodeObject(k)],  // key
          expiry,                   // lifespan & max idle
  ...
  var IdsMixin = {
    getBulkId: function() { return 0x19; },
    getBulkWithMetaId: function() { return 0x1B; },
    ...
    iterStartId: function() { return 0x31 },
    iterNextId: function() { return 0x33 },
    iterEndId: function() { return 0x35 }
  };
