...
(function() {
  ...
  var Protocol = function() {
    ...
    return {
      encodeK: function (msgId, opCode, k, opts) {
        return chain(f.cat(header(msgId, opCode), key(k, opts)));
      },
  ...
  var Client = function(host, port) {
    ...
    return {
      ...
      removeWithVersion: function(k, version) {
        var opts = {version: version};
        return f.pipeline(ctx(SMALL), enc(REMOVE_WITH_VERSION, _proto.encodeK, k, opts), write);
      }
    }
  };
