      ...
      connect: function() {
        ...
        return transport.connect()
            ...
            .then(function() {
              ...
              logger.error('Invoke auth(msgId=%d)', ctx.id);
              return future(ctx, 0x23, p.plainAuth('admin', 'mypassword'), p.decodePlainAuth);
            })
            .then(function() {
              console.log('Authentication executed %s' + client);
              return client; // return client
            })
