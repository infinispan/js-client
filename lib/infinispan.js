...
(function() {
  ...
  var Client = function(addrs, clientOpts) {
    ...
    function protocolResolver(version) {
      switch (version) {
        case '2.8': return protocols.version28(clientOpts);
   ...
   * @property {?Number} maxRetries - Optional number of retries for operation.
   * @property {?boolean} ssl.enabled - Optional flag to enable SSL support.
   * @property {?String} ssl.secureProtocol - Optional field with secure protocol in use.
   ...
   * @property {?boolean} topologyUpdates - Optional flag to controls whether the client deals with topology updates or not.
   * @property {?String} mediaType - Media type of the cache contents.
   * @property {?[Cluster]} clusters - Optional additional clusters for cross-site failovers.
   * @since 0.3
   */
  Client.config = {
    version: '2.8',         // Hot Rod protocol version
