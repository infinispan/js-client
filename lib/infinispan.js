      ...
      connect: function(client, host, port) {
        return new Promise(function (succeed, fail) {
          ...
          _client.on('data', function(data) {
            ...
            //logger.tracef("Data callback with buffer size is %d, and offset %d", bytebuf.buf.length, bytebuf.offset);
            while (bytebuf.buf.length > bytebuf.offset) {
              try {
              ...
              try {
                ...
                logger.tracef("After decoding request(msgId=%d), buffer size is %d, and offset %d", msgId, bytebuf.buf.length, bytebuf.offset);
