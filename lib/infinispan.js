  ...
  var Client = function(host, port) {
    ...
    return {
      ...
      put: function(k, v, opts) {
        ...
        return future(MEDIUM, PUT, p.keyValue(k, v), decoder, opts);
      },
      ...
      putIfAbsent: function(k, v, opts) {
        ...
        return future(MEDIUM, PUT_IF_ABSENT, p.keyValue(k, v), decoder, opts);
      },
      ...
      replace: function(k, v, opts) {
        var decoder = p.decodePrevOrElse(opts, p.hasSuccess, p.hasSuccess);
        return future(MEDIUM, REPLACE, p.keyValue(k, v), decoder, opts);
      },
