...
(function() {
  ...
  var Client = function(addrs, clientOpts) {
    ...
    return {
       ...
       * A promise that will be completed with the values associated with
       * the query, or undefined if the no values matches the query.
       * @memberof Client#
       * @since 1.3
       */
      query: function(q) {
      ...
      registerProtrostreamType: function(typeName,descriptorId){
