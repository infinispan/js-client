...
(function() {
  ...
  var Client = function(addrs, clientOpts) {
    ...
    return {
       ...
       */
      /**
       * Get the value and version associated with the given key parameter.
       *
       * @param k {String} Key to retrieve.
       * @returns {module:promise.Promise.<?VersionedValue>}
       * A promise that will be completed with the value and version
       ...
       * one in the server for the operation to succeed.
       * @param opts {?StoreOptions} Optional store options.
       * @returns {module:promise.Promise.<(Boolean|?String)>}
      ...
      /**
       * Bulk get operation. It optionally takes the number of entries to
       * return. There's no guarantee on the order in which entries will be
       * received, and when retrieval is limited to a number of entries,
       * there's no guarantee which entries will be retrieved.
       *
       * @param count {?Number} Optional count of entries to return.
       * @returns {module:promise.Promise.<Entry[]>}
       * A promise that will be completed with an array of entries.
       * @memberof Client#
       * @since 0.3
       */
      ...
      /**
       * Bulk get keys operation. It optionally takes the number of keys to
       * return. There's no guarantee on the order in which keys will be
       * received, and when retrieval is limited to a number of keys,
       * there's no guarantee which keys will be retrieved.
       *
       * @param count {?Number} Optional count of keys to return.
       * @returns {module:promise.Promise.<String[]>}
       * A promise that will be completed with an array of keys.
       * @memberof Client#
       * @since 0.3
       */
